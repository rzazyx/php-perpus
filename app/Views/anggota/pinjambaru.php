         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-12">
                  <div class="card">
                     <div class="card-body">
                        <h4 class="card-title">Siklus Peminjaman Pustaka - Peminjaman Baru</h4>
                        <h6 class="card-subtitle mb-3">masukkan jumlah pustaka yang akan diproses, lalu pilih tombol <code>Pinjam Pustaka</code> untuk menambahkan data. pilih tombol <code>Simpan</code> untuk menyimpan Peminjaman pustaka</h6>
                        <form action="<?php echo base_url('p/pinjamtambahdetail') ?>" method="post">
                           ...
                           <div class="input-group">
                              ...
                              <div class="input-group-append">
                                 <button class="btn btn-success" type="submit">Pinjam Pustaka</button>
                              </div>
                           </div>
                        </form>
                        <br>
                     ...
                     <form method="post" action="<?php echo base_url('p/pinjamsimpan') ?>">
                        ...
                        <div class="card-footer">
                           <a href="<?php echo base_url('p/pinjam') ?>" class="btn btn-primary btn-sm">Kembali</a>
                           <?php if(count($detail) > 0){ ?>
                              <button type="submit" class="btn waves-effect waves-light btn-sm btn-success" style="float: right;">Simpan</button>
                           <?php } ?>
                        </div>
                     </form>
                  </div>
